...
// Badge shadcn v4 : sans bordure par défaut (border-transparent), font-medium.
// Couleurs custom : passer les classes de lib/status-color.ts ou lib/model-color.ts
// en className (recette docs shadcn : bg-{teinte}-50 text-{teinte}-700 dark:bg-{teinte}-950 dark:text-{teinte}-300).
