...
export default async function ModulePage({
  ...
  // La dernière session de chaque cas, pour le lien « Voir » à côté de « Rejouer ». Même garde
  // que les bests : sans droit Entraînement, pas de sessions à soi, on n'interroge pas.
