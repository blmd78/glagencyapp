...
export async function getMktStaff(period: Period): Promise<MktStaffData> {
  ...
  // Paiements des MOIS couverts par la période (les payes staff sont mensuelles) — ne
  // dépend que de `period`, calculé AVANT le Promise.all pour entrer dans la même vague.
