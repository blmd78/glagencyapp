...
export async function getOverview(
  ...
  // Y du KPI « Chatteurs actifs X / Y » : admin/encadrant = MEMBRES rôle chatteur (effectif
  // réel) ; restricted = liaisons actives ∪ chatteurs avec CA sur la période — X ≤ Y garanti.
