...
/**
 * DÉFINITION DES COLONNES de la table Spenders. Extrait de `spenders-table.tsx`
...
export const makeColumns = (isAdmin: boolean, canWrite: boolean, tracker: boolean, readOnly: boolean): ColumnDef<SpenderRow>[] => [
  {
