...
import { sumLinks, type LinkOption, type Reseau } from '../link-options'
import type { DailyPoint } from '../daily-series'
import type { MktLinkRow } from '@/lib/types/marketing'

/**
 * Le mode Graphique : on choisit un réseau, puis un lien (ou tous), on lit le jour par jour.
 *
...
export function LinkGraphView({
  ...
  /** Les liens tracés : un seul, ceux d'un réseau, ou toute l'agence. */
  selected: MktLinkRow[]
  points: DailyPoint[]
  options: LinkOption[]
  reseau: Reseau
  ...
  return (
    <div className="flex flex-col gap-6">
      <LinkPicker options={options} reseau={reseau} lien={lien} />
