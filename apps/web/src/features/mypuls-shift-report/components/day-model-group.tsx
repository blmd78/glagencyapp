...
import { DayChatterRow } from './day-chatter-row'
import type { DayModelGroup as DayModelGroupData } from '../types'
      ...
      <summary className="flex cursor-pointer list-none items-center gap-3 px-4 py-3 hover:bg-muted/50 [&::-webkit-details-marker]:hidden">
        ...
        <span className="text-sm text-muted-foreground">
          ...
          {group.belowCount > 0 && (
            <>
              {' · '}
              {/* Compté sur le seul créneau ATTENDU (D7) : le renfort n'entre jamais dans ce
                  chiffre, sa couverture étant minuscule par construction. */}
