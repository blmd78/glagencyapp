 ...
 *
 * Copie de `apps/web/src/lib/supabase/fetch-all.ts` (même contrat) : portée ici pour
 * `apps/ingestion`, qui ne peut pas importer `apps/web`. Vocation à devenir LE seul
 * exemplaire partagé web/ingestion ; aujourd'hui seule l'ingestion l'importe d'ici.
 */
